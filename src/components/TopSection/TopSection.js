    ...
    <main className="TopSection mt-20">
      <div className="flex justify-center flex-col md:flex-row">
        <div className="flex-1">
          <h1 className="sectionTitle ml-10 md:ml-20">Worrying about luggage?</h1>
      ...
      <div className="flex flex-col-reverse  md:flex-row mt-20">
        ...
        <div className="flex-1">
            <h1 className="sectionTitle text-right mr-10 md:mr-20">Hassle free parkings all over the city</h1>
            <p className="sectionDetails text-right mr-10 md:mr-20">Whether it's your car, your scooter or cycle <br/> we have space fo everyone and everything <br/>so that you can be tension free while your visit</p>
        </div>
      </div>
    </main>
  );
